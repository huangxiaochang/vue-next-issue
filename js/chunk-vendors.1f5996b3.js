...
function resetStoreState (store, state, hot) {
  ...
  store._state = Object(vue__WEBPACK_IMPORTED_MODULE_0__[/* reactive */ "s"])({
    data: state
  });
...
function enableStrictMode (store) {
  Object(vue__WEBPACK_IMPORTED_MODULE_0__[/* watch */ "y"])(function () { return store._state.data; }, function () {
    {
...
Store.prototype.watch = function watch$1 (getter, cb, options) {
  ...
  return Object(vue__WEBPACK_IMPORTED_MODULE_0__[/* watch */ "y"])(function () { return getter(this$1$1.state, this$1$1.getters); }, cb, Object.assign({}, options))
};
...
function registerGuard(record, name, guard) {
    ...
    Object(vue__WEBPACK_IMPORTED_MODULE_0__[/* onUnmounted */ "n"])(removeFromList);
    Object(vue__WEBPACK_IMPORTED_MODULE_0__[/* onDeactivated */ "m"])(removeFromList);
    Object(vue__WEBPACK_IMPORTED_MODULE_0__[/* onActivated */ "l"])(() => {
...
function onBeforeRouteLeave(leaveGuard) {
    if (false) {}
    const activeRecord = Object(vue__WEBPACK_IMPORTED_MODULE_0__[/* inject */ "j"])(matchedRouteKey, {}).value;
    if (!activeRecord) {
        ( false) &&
            false;
        return;
...
function useLink(props) {
    const router = Object(vue__WEBPACK_IMPORTED_MODULE_0__[/* inject */ "j"])(routerKey);
    const currentRoute = Object(vue__WEBPACK_IMPORTED_MODULE_0__[/* inject */ "j"])(routeLocationKey);
    const route = Object(vue__WEBPACK_IMPORTED_MODULE_0__[/* computed */ "b"])(() => router.resolve(Object(vue__WEBPACK_IMPORTED_MODULE_0__[/* unref */ "w"])(props.to)));
    ...
    function navigate(e = {}) {
        if (guardEvent(e))
            return router[Object(vue__WEBPACK_IMPORTED_MODULE_0__[/* unref */ "w"])(props.replace) ? 'replace' : 'push'](Object(vue__WEBPACK_IMPORTED_MODULE_0__[/* unref */ "w"])(props.to));
...
const RouterLinkImpl = /*#__PURE__*/ Object(vue__WEBPACK_IMPORTED_MODULE_0__[/* defineComponent */ "g"])({
    name: 'RouterLink',
    props: {
        to: {
            type: [String, Object],
    ...
    setup(props, { slots }) {
        const link = Object(vue__WEBPACK_IMPORTED_MODULE_0__[/* reactive */ "s"])(useLink(props));
        const { options } = Object(vue__WEBPACK_IMPORTED_MODULE_0__[/* inject */ "j"])(routerKey);
        ...
        return () => {
            ...
            return props.custom
                ? children
                : Object(vue__WEBPACK_IMPORTED_MODULE_0__[/* h */ "i"])('a', {
...
const RouterViewImpl = /*#__PURE__*/ Object(vue__WEBPACK_IMPORTED_MODULE_0__[/* defineComponent */ "g"])({
    name: 'RouterView',
    ...
    setup(props, { attrs, slots }) {
        ( false) && false;
        const injectedRoute = Object(vue__WEBPACK_IMPORTED_MODULE_0__[/* inject */ "j"])(routerViewLocationKey);
        const routeToDisplay = Object(vue__WEBPACK_IMPORTED_MODULE_0__[/* computed */ "b"])(() => props.route || injectedRoute.value);
        const depth = Object(vue__WEBPACK_IMPORTED_MODULE_0__[/* inject */ "j"])(viewDepthKey, 0);
        const matchedRouteRef = Object(vue__WEBPACK_IMPORTED_MODULE_0__[/* computed */ "b"])(() => routeToDisplay.value.matched[depth]);
        Object(vue__WEBPACK_IMPORTED_MODULE_0__[/* provide */ "q"])(viewDepthKey, depth + 1);
        Object(vue__WEBPACK_IMPORTED_MODULE_0__[/* provide */ "q"])(matchedRouteKey, matchedRouteRef);
        Object(vue__WEBPACK_IMPORTED_MODULE_0__[/* provide */ "q"])(routerViewLocationKey, routeToDisplay);
        const viewRef = Object(vue__WEBPACK_IMPORTED_MODULE_0__[/* ref */ "t"])();
        // watch at the same time the component instance, the route record we are
        // rendering, and the name
        Object(vue__WEBPACK_IMPORTED_MODULE_0__[/* watch */ "y"])(() => [viewRef.value, matchedRouteRef.value, props.name], ([instance, to, name], [oldInstance, from, oldName]) => {
        ...
        return () => {
            ...
            const component = Object(vue__WEBPACK_IMPORTED_MODULE_0__[/* h */ "i"])(ViewComponent, assign({}, routeProps, attrs, {
                onVnodeUnmounted,
                ref: viewRef,
            }));
            return (
...
function warnDeprecatedUsage() {
    const instance = Object(vue__WEBPACK_IMPORTED_MODULE_0__[/* getCurrentInstance */ "h"])();
...
function addDevtools(app, router, matcher) {
    ...
    Object(_vue_devtools_api__WEBPACK_IMPORTED_MODULE_1__["setupDevtoolsPlugin"])({
        ...
        Object(vue__WEBPACK_IMPORTED_MODULE_0__[/* watch */ "y"])(router.currentRoute, () => {
...
function createRouter(options) {
    ...
    const currentRoute = Object(vue__WEBPACK_IMPORTED_MODULE_0__[/* shallowRef */ "v"])(START_LOCATION_NORMALIZED);
    ...
    function handleScroll(to, from, isPush, isFirstNavigation) {
        ...
        let scrollPosition = (!isPush && getSavedScrollPosition(getScrollKey(to.fullPath, 0))) ||
            ...
            null;
        return Object(vue__WEBPACK_IMPORTED_MODULE_0__[/* nextTick */ "k"])()
    ...
    const router = {
        ...
        install(app) {
            ...
            Object.defineProperty(app.config.globalProperties, '$route', {
                enumerable: true,
                get: () => Object(vue__WEBPACK_IMPORTED_MODULE_0__[/* unref */ "w"])(currentRoute),
            });
            ...
            app.provide(routeLocationKey, Object(vue__WEBPACK_IMPORTED_MODULE_0__[/* reactive */ "s"])(reactiveRoute));
 ...
 */
function useRouter() {
    return Object(vue__WEBPACK_IMPORTED_MODULE_0__[/* inject */ "j"])(routerKey);
}
/**
 ...
 */
function useRoute() {
    return Object(vue__WEBPACK_IMPORTED_MODULE_0__[/* inject */ "j"])(routeLocationKey);
}
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "s", function() { return /* reexport */ reactive; });
__webpack_require__.d(__webpack_exports__, "t", function() { return /* reexport */ reactivity_esm_bundler_ref; });
__webpack_require__.d(__webpack_exports__, "v", function() { return /* reexport */ shallowRef; });
__webpack_require__.d(__webpack_exports__, "w", function() { return /* reexport */ unref; });
...
__webpack_require__.d(__webpack_exports__, "g", function() { return /* reexport */ defineComponent; });
__webpack_require__.d(__webpack_exports__, "h", function() { return /* reexport */ getCurrentInstance; });
__webpack_require__.d(__webpack_exports__, "i", function() { return /* reexport */ h; });
__webpack_require__.d(__webpack_exports__, "j", function() { return /* reexport */ inject; });
__webpack_require__.d(__webpack_exports__, "k", function() { return /* reexport */ nextTick; });
__webpack_require__.d(__webpack_exports__, "l", function() { return /* reexport */ onActivated; });
__webpack_require__.d(__webpack_exports__, "m", function() { return /* reexport */ onDeactivated; });
__webpack_require__.d(__webpack_exports__, "n", function() { return /* reexport */ onUnmounted; });
__webpack_require__.d(__webpack_exports__, "o", function() { return /* reexport */ openBlock; });
__webpack_require__.d(__webpack_exports__, "p", function() { return /* reexport */ popScopeId; });
__webpack_require__.d(__webpack_exports__, "q", function() { return /* reexport */ provide; });
__webpack_require__.d(__webpack_exports__, "r", function() { return /* reexport */ pushScopeId; });
__webpack_require__.d(__webpack_exports__, "u", function() { return /* reexport */ resolveComponent; });
__webpack_require__.d(__webpack_exports__, "y", function() { return /* reexport */ watch; });
__webpack_require__.d(__webpack_exports__, "z", function() { return /* reexport */ withCtx; });
__webpack_require__.d(__webpack_exports__, "A", function() { return /* reexport */ withScopeId; });
__webpack_require__.d(__webpack_exports__, "c", function() { return /* reexport */ runtime_dom_esm_bundler_createApp; });
__webpack_require__.d(__webpack_exports__, "x", function() { return /* reexport */ useCssVars; });

// UNUSED EXPORTS: customRef, isProxy, isReactive, isReadonly, isRef, markRaw, proxyRefs, readonly, shallowReactive, shallowReadonly, toRaw, toRef, toRefs, triggerRef, camelize, capitalize, toDisplayString, toHandlerKey, BaseTransition, Comment, KeepAlive, Static, Suspense, Teleport, Text, callWithAsyncErrorHandling, callWithErrorHandling, cloneVNode, compatUtils, createCommentVNode, createHydrationRenderer, createRenderer, createSlots, createStaticVNode, defineAsyncComponent, defineEmit, defineProps, devtools, getTransitionRawChildren, handleError, initCustomFormatter, isRuntimeOnly, isVNode, mergeProps, onBeforeMount, onBeforeUnmount, onBeforeUpdate, onErrorCaptured, onMounted, onRenderTracked, onRenderTriggered, onServerPrefetch, onUpdated, queuePostFlushCb, registerRuntimeCompiler, renderList, renderSlot, resolveDirective, resolveDynamicComponent, resolveFilter, resolveTransitionHooks, setBlockTracking, setDevtoolsHook, setTransitionHooks, ssrContextKey, ssrUtils, toHandlers, transformVNodeArgs, useContext, useSSRContext, useTransitionState, version, warn, watchEffect, withDirectives, Transition, TransitionGroup, createSSRApp, hydrate, render, useCssModule, vModelCheckbox, vModelDynamic, vModelRadio, vModelSelect, vModelText, vShow, withKeys, withModifiers, compile
...
//# sourceMappingURL=chunk-vendors.1f5996b3.js.map